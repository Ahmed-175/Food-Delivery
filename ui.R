  ...
  fluidRow(
    ...
    column(
      ...
      tabsetPanel(
        ...
        tabPanel("Delivery Distribution", 
          plotOutput("time_of_day_pie", height = "500px")
        ),
        tabPanel("Performance of Vehicle", tableOutput("vehicle_table"), tableOutput("TestTableWeather")),
        outliers_ui,
        kmeans_ui,
        cluster_summary_ui,
        tree_ui,
